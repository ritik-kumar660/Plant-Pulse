...
$last_watered = $plant['last_watered'] ? date('Y-m-d', strtotime($plant['last_watered'])) : '';
$last_fertilized = $plant['last_fertilized'] ? date('Y-m-d', strtotime($plant['last_fertilized'])) : '';
$last_repotted = $plant['last_repotted'] ? date('Y-m-d', strtotime($plant['last_repotted'])) : '';
?>
<!DOCTYPE html>
<html lang="en">
<head>
